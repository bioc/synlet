...
The **exampleDat** is a data.frame containing 8 columns, all of them are mandatory and please do **NOT** change the column names.
Besides that, users are free to add new columns. However, please not that the new columns may not appear in the final results. Users need to generate **exampleDat** like data.frame from the screen results.
...
```
*bscore.res* is a list containing B-score of plates belonging to the same master plate. The first three plates are **treament**,
